...
SELECT (S1.eID) AS 'Person 1 ID', (Select ename from employee where S2.eID = employee.eID)as 'person 1 name' , (S2.eID) AS 'Person 2 ID' , ename as 'person 2 name', count(employee.eID) as 'Common Skill' FROM employee
